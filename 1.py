...
print('\x1b[1;91m[\x1b[1;97m-\x1b[1;91m] \x1b[1;92m WELCOME Jone my Teligerm . . . .')
os.system('xdg-open https://t.me/Tarmux_OX_FREE_SCRIPT')
os.system('xdg-open https://t.me/Tarmux_OX_FREE_SCRIPT')
os.system('xdg-open https://t.me/Tarmux_OX_FREE_SCRIPT')
time.sleep(2)
...
class ASIMCracker:
    ...
    def breach_target(self, target, passlist):
        self.loop += 1
        sys.stdout.write(f'\r  {self.color.W}[ASIM] {self.loop}|{self.color.R}{len(self.oks)}|{self.color.G}{len(self.cps)}{self.color.W}')
        sys.stdout.flush()
